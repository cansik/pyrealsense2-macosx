param(
    ...
    [Parameter(ValueFromRemainingArguments = $true)][String[]]$PythonExecutables = @("python3.8", "python3.9", "python3.10", "python3.11", "python3.12")
)
...
foreach ($PythonExec in $PythonExecutables)
{
    ...
    & "librealsense-python-mac.ps1 -clean"
